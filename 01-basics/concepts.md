...
和**热钱包**，以及私钥是否在你手中可分为**托管钱包 (Custodial Wallets)**和**非托管钱包 (Non-custodial Wallet)**。
...
关于**托管**和**非托管**钱包，核心区别就是你有没有钱包地址的**私钥**/**助记词**，没有的话就是
托管钱包，常见于中心化交易所充值的钱包地址，本质和现实银行账号一样，就是银行/交易所宣称是给你用的，
但是他们随时可以转走里面的钱/资产。如果钱包地址的**私钥**/**助记词**是完全掌握在你手里的，那么
这就叫**非托管**，或者叫**自托管 (Self-custody)**，这才是区块链的精髓，只要你不将你的私钥泄露
出去，那么除你自己之外没人可以转走你钱包里的钱/资产。从这个角度来说，冷钱包一定是非托管的，热钱包
其实就看软件厂商的良心了，理论上只要联网软件钱包就能将你的私钥上传到对应的服务器，不过一般来说，
常用的钱包都是开源的，同时使用人也多，相对比较安全。

> 交易所钱包 (Web3 钱包)：目前来说，知名的交易所都会有一个他们自己的 Web3 钱包，也就是非托管钱包。
> 但是有些交易所的 Web3 钱包看似是非托管，其实是通过隐蔽的手段将你创建钱包时的一些信息记录了下来，
> 然后有对应的算法去根据这些信息计算出对应的私钥/助记词，所以，对于交易所的 Web3 钱包还是谨慎
> 使用吧，最好还是选择适用人群最多且开源的钱包。
